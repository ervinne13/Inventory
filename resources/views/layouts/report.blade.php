...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="all" href="{{skarla_vendor_url("css/lib.min.css")}}">

        <!-- SCSS Output -->
        <!--<link rel="stylesheet" href="../assets/stylesheets/app.min.b288c87c.css">-->
        
        <link rel="stylesheet" type="text/css" media="all" href="{{skarla_css_url("bootstrap.css")}}">        
        <link rel="stylesheet" type="text/css" media="all" href="{{skarla_css_url("plugins.css")}}">        

        @yield('vendor-css')
        @include("layouts.parts.default-css")

        <link rel="stylesheet" type="text/css" media="all" href="{{skarla_css_url("app.css")}}">
        <!--<link rel="stylesheet" href="{{skarla_css_url("app.min.e7c8016f.css")}}">-->
        <link rel="stylesheet" type="text/css" media="all" href="{{url("css/app.css")}}">
        ...
        <link rel="stylesheet" type="text/css" media="print" href="{{skarla_css_url("bootstrap.css")}}">
    ...
    <body class="sidebar-full-height sidebar-disabled navbar-disabled footer-disabled ">
