...
@section('js')
<script src="{{url("js/pages/master-files/suppliers/index.js")}}"></script>
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="row m-b-2">
            ...
            <div class=" m-t-1 col-md-4  col-sm-4  col-xs-4 col-xs-offset-4 col-sm-offset-4 col-md-offset-4 text-right">
                <a href="{{url("master-files/suppliers/create")}}" class="btn btn-sm btn-success">
        ...
        <div class="panel panel-default b-a-0 p-10 shadow-box">
            ...
            "columns" => ["", "Supplier Number", "Display Name"]
            ])
